# Scheduler baseline — World Cup daily briefing
...
|-------|--------|
| `baseline-version` | **2** |
| Task prompt | [../worldcup-daily.md](../worldcup-daily.md) |
...
2. https://mtm0101.github.io/public-sites/claude-cowork/ielts-hourly-practice-tool/prompts/chatgpt/worldcup-daily.md?t=<unix_ts>
