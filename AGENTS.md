# BBC 6 Minute English Lesson Generator — Codex Prompt

Paste this entire prompt into Codex (or save as a AGENTS.md in the project folder).
...
- **Lessons folder:** `C:\Users\USERNAME\Downloads\gpt-codex\public-sites\docs\Codex-cowork\bbc-lessons`
- **State file:** `C:\Users\USERNAME\Downloads\gpt-codex\public-sites\docs\Codex-cowork\bbc-lessons\bbc-6min-sent.json`
...
Reference: `bbc-Codex-211021-what-makes-us-laugh.json` (app) / `bbc-6min-2021-10-21-what-makes-us-laugh.html`
...
git add docs/Codex-cowork/bbc-lessons/
...
3. Action: Start a program
   - Program: `Codex`
   - Arguments: `--print "run bbc lesson task per AGENTS.md" --dangerously-skip-permissions`
   - Start in: `C:\Users\USERNAME\Downloads\gpt-codex\public-sites`

Or save this prompt as `AGENTS.md` in the repo root and just run `Codex` from that folder.
